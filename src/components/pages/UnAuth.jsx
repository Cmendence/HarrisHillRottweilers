...
export default function UnAuth() {
  ...
  return (
    <div>
      <h1 className="lg:text-4xl text-3xl font-semibold my-6 text-center text-gray-800">
        Aw Biscuits!
      </h1>
      <p className="lg:text-xl font-semibold text-center text-gray-800">
      ...
      <div className="flex flex-col items-center">
        <figure className="flex flex-col items-center my-6">
          <img
            src={SadDog}
            alt="Dog laying on floor looking up"
            className=" rounded-md lg:w-1/3 w-4/5 shadow-md shadow-black"
          />
          <figcaption className="font-semibold mt-2 text-xs">
            Photo by{" "}
            <a
              className="text-rose-800"
              href="https://unsplash.com/@kvnsbl"
              rel="noopener"
              target="_blank"
            >
              Kevin Seibel
