...
const [showSuccessMessage, setShowSuccessMessage] = useState(false);
  ...
  const handleCheckboxChange = (e) => {
    ...
    setForm({ ...form, gender: checked ? name : "" });
  };

  const handleTagChange = (e) => {
   const { value } = e.target;
   if (!form.tags.includes(value) && value !== "") {
     setForm({ ...form, tags: [...form.tags, value], tag: value });
   }
 };
 ...
 const handleDeleteDog = async (id) => {
   ...
   try {
     ...
     console.log("Dog deleted successfully:", id);
   } catch (error) {
    ...
    <div className="lg:m-12 mt-4 m-4 font-semibold">
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg shadow-gray-600 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            <label className="ml-2 text-gray-100" htmlFor="tags">
              Tags
            </label>
            <select
            value={form.tag}
          ...
          <div className="m-2 py-2 rounded-md focus:outline-rose-800 indent-2 pr-4">
            {form.tags.map((tag, index) => (
              ...
              >
                {tag} <button className="text-red-500 font-bold" onClick={() => handleRemoveTag(tag)}>X</button>
              </span>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {dogs.map((dog) => (
            ...
            >
              ...
              <p className="text-gray-300">Age: {dog.age}</p>
